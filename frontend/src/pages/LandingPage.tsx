...
// --- Inline Hook: useScrollDirection ---
...
const Navbar: React.FC<{ isDark: boolean; toggleTheme: () => void; onStart: () => void }> = ({ isDark, toggleTheme, onStart }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-6">
        ...
        <button onClick={onStart} className="glow-btn hidden md:block">
          Launch App
        </button>
      </div>
    </motion.nav>
